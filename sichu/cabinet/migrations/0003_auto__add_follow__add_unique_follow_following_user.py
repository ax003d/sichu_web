...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Follow'
        db.create_table('cabinet_follow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('following', self.gf('django.db.models.fields.related.ForeignKey')(related_name='follower_set', to=orm['auth.User'])),
            ('remark', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('cabinet', ['Follow'])

        # Adding unique constraint on 'Follow', fields ['following', 'user']
        db.create_unique('cabinet_follow', ['following_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Follow', fields ['following', 'user']
        db.delete_unique('cabinet_follow', ['following_id', 'user_id'])

        # Deleting model 'Follow'
        db.delete_table('cabinet_follow')
