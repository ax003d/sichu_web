...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WeiboUser.expires_in'
        db.alter_column('cabinet_weibouser', 'expires_in', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'WeiboUser.expires_in'
        db.alter_column('cabinet_weibouser', 'expires_in', self.gf('django.db.models.fields.IntegerField')())
