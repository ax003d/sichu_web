...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BookBorrowRequest.datetime'
        db.alter_column('cabinet_bookborrowrequest', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'BookBorrowRequest.datetime'
        db.alter_column('cabinet_bookborrowrequest', 'datetime', self.gf('django.db.models.fields.DateTimeField')())
